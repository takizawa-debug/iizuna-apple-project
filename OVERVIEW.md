...
- **[Web版ダッシュボード](https://script.google.com/macros/s/AKfycbwjRQRr9Y59rsWFdHcOYYOg59iPqDL5Fl7TJB6_dWT4nQ8M-YGAMRerZpJPjnHR0c9qlA/exec?mode=dashboard)**: パラメータを正規化したページ別集計に加え、個別モーダル（むーちゃん等の記事）の人気度を階層別に分析可能。
