  ...
  <form id="lzMasterForm">
    ...
    <div id="pane-article" class="lz-form-body">
      ...
      <div id="article-fields-container" style="display:none; flex-direction:column; gap:32px;">
        ...
        <div class="lz-field"><label class="lz-label"><span class="lz-badge">必須</span> <span id="lbl-lead">概要</span></label><textarea name="art_lead" class="lz-textarea" rows="2" maxlength="100" placeholder="お店やイベントを一言で表すと？" required></textarea></div>
        ...
        <div class="lz-field">
          ...
          <div id="imagePreviewContainer" class="lz-image-upload-container">
            <label class="lz-image-add-btn" id="imageAddTrigger">
              <span>+</span><small>画像を追加</small>
              <input type="file" id="artImagesInput" name="art_images" accept="image/*" multiple style="display:none;">
            </label>
          </div>
        </div>
        ...
        <div class="lz-grid">
          <div class="lz-field"><label class="lz-label"><span class="lz-badge">必須</span> 郵便番号</label><div style="display:flex; gap:10px;"><input type="text" id="zipCode" name="shop_zip" class="lz-input" placeholder="389-1211"><button type="button" class="lz-zip-btn" id="zipBtnAction">住所検索</button></div></div>
        ...
        <div id="pane-shop-detail" class="lz-dynamic-detail" style="display:none;">
          ...
          <div id="shop-simple">
            ...
            <div class="lz-field"><label class="lz-label">標準営業時間</label><div class="lz-time-row"><div class="lz-time-field"><span class="lz-time-label-sm">営業開始</span><div id="sel-simple-start" class="lz-time-box"></div></div><div class="lz-time-field"><span class="lz-time-label-sm">営業終了</span><div id="sel-simple-end" class="lz-time-box"></div></div></div></div>
          </div>
          ...
          <div class="lz-field"><label class="lz-label">祝日の営業</label><select name="shop_holiday_type" class="lz-select"><option value="">設定しない（未回答）</option><option value="follow_regular">曜日どおり営業 / 定休（カレンダーに従う）</option><option value="always_open">祝日は営業（定休日であっても営業する）</option><option value="always_closed">祝日は休業（営業日であっても休業する）</option><option value="irregular">不定休・特別ダイヤ（詳細は注意事項に記載）</option></select></div>
          <div class="lz-field"><label class="lz-label">営業に関する注意事項</label><textarea name="shop_notes" class="lz-textarea" rows="3" placeholder="（例）毎月最終月曜日は定休日です。"></textarea></div>
        </div>
        ...
        <div id="box-sns-links" class="lz-field">
          ...
          <div id="sns-inputs" style="display:flex; flex-direction:column; gap:12px; margin-top:15px;">
            ...
            <div id="f-ec" style="display:none;"><input type="url" name="url_ec" class="lz-input" placeholder="通販サイトURL"></div>
            ...
            <div id="f-x" style="display:none;"><input type="text" name="sns_x" class="lz-input" placeholder="X ID"></div>
        ...
        <div id="pane-event-detail" class="lz-dynamic-detail" style="display:none;">
          ...
          <div class="lz-grid"><div class="lz-field"><label class="lz-label">開始時刻</label><div class="lz-time-row"><div class="lz-time-box" id="sel-ev-s"></div></div></div><div class="lz-field"><label class="lz-label">終了時刻</label><div class="lz-time-row"><div class="lz-time-box" id="sel-ev-e"></div></div></div></div>
        </div>
        ...
        <div id="syncField" style="display:none; margin-bottom:10px;">
          <label class="lz-choice-item lz-sub-choice-item" style="width:fit-content;"><input type="checkbox" id="syncCheck"><span class="lz-choice-inner">掲載用メールを連絡用にも使う</span></label>
        </div>
