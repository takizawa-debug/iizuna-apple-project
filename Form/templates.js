  ...
  <form id="lzMasterForm">
    ...
    <div id="pane-article" class="lz-form-body">
      ...
      <div id="article-fields-container" style="display:none; flex-direction:column; gap:32px;">
        ...
        <div class="lz-field"><label class="lz-label"><span class="lz-badge">必須</span> 概要</label><textarea name="art_lead" class="lz-textarea" rows="2" maxlength="100" placeholder="100文字以内でご記入ください" required></textarea></div>
        ...
        <div id="pane-shop-detail" class="lz-dynamic-detail" style="display:none;">
          ...
          <div id="shop-simple">
            ...
            <div class="lz-field"><label class="lz-label">標準営業時間</label><div class="lz-time-row"><div class="lz-time-field"><span class="lz-time-label-sm">開始</span><div id="sel-simple-start" class="lz-time-box"></div></div><div class="lz-time-field"><span class="lz-time-label-sm">終了</span><div id="sel-simple-end" class="lz-time-box"></div></div></div></div>
          </div>
          <div id="shop-custom" style="display:none;"><div class="lz-schedule-container"><table class="lz-schedule-table"><thead><tr><th>曜日</th><th>休業</th><th>開始</th><th>終了</th></tr></thead><tbody id="customSchedBody"></tbody></table></div></div>
        ...
        <div class="lz-field">
          ...
          <div id="syncField" style="display:none; margin-bottom: 8px;">
            <label class="lz-choice-item" style="width:fit-content;"><input type="checkbox" id="syncCheck"><span class="lz-choice-inner" style="min-height:34px; padding:4px 12px; font-size:0.95rem; border-radius:20px;">掲載用メールと同じにする</span></label>
          </div>
