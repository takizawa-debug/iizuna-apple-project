    ...
    <div id="pane-article" class="lz-form-body">
      ...
      <div class="lz-field">
        ...
        <div class="lz-choice-group-main">
          <label class="lz-choice-label"><input type="radio" name="art_type" value="shop" checked> お店の登録</label>
      ...
      <div id="sub-consult" class="lz-dynamic-sub-area">
        ...
        <div class="lz-choice-group-sub">
          ...
          <label class="lz-sub-label"><input type="checkbox" name="cat_consult" value="士業"> 士業（士業・専門職）</label>
      ...
      <div id="sub-industry" class="lz-dynamic-sub-area">
        ...
        <div class="lz-choice-group-sub">
          ...
          <label class="lz-sub-label"><input type="checkbox" name="cat_industry" value="建築"> 建築・設備工事</label>
...
export const formCommonHTML = `
  ...
  <div class="lz-grid">
    ...
    <div class="lz-field"><label class="lz-badge opt" style="background:#999;">任意</span> 配布資料（PDF等）</label><input type="file" name="art_file" class="lz-input" accept=".pdf,.doc,.docx,.zip"></div>
  </div>

  <div id="pane-shop-detail" class="lz-dynamic-detail" style="display:flex;">
  ...
  <div id="pane-event-detail" class="lz-dynamic-detail">
