...
const resources = {
  ...
  en: {
    ...
    links: {
      ...
      ig: { label: "Instagram", placeholder: "@username or profile URL" },
      fb: { label: "Facebook", placeholder: "Profile URL" },
      x: { label: "X (formerly Twitter)", placeholder: "@username or profile URL" },
      line: { label: "LINE Official Account", placeholder: "LINE ID or profile URL" },
      tt: { label: "TikTok", placeholder: "@username or profile URL" },
    ...
    placeholders: {
        ...
        ev_fee: "Free, 500 yen, etc.", ev_items: "Stationery, shoes, etc.", ev_target: "Residents, students, etc.",
