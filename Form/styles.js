export const formStyles = `
  ...
  .lz-choice-inner { display: flex; align-items: center; justify-content: center; padding: 12px 20px; background: #fff; border: 1px solid #eee; border-radius: 12px; font-size: 1.1rem; font-weight: 800; color: #666; transition: all 0.2s ease; min-height: 52px; box-sizing: border-box; }
  ...
  .lz-sub-choice-item .lz-choice-inner { min-height: 48px; padding: 10px 20px; border-radius: 30px; font-size: 1.05rem; }
  ...
  /* 曜日チップ */
  .lz-day-selector { display: flex !important; flex-wrap: wrap !important; gap: 6px !important; justify-content: flex-start !important; width: 100% !important; margin-top: 8px; }
  ...
  /* テーブル：1.1rem にアップ */
  .lz-schedule-table th, .lz-schedule-table td { padding: 14px 20px; border: 1px solid #eee; text-align: center; font-size: 1.1rem; }
  .lz-schedule-table th { background: #fdfaf8; color: #5b3a1e; font-weight: 800; font-size: 1.05rem; }

  @media (max-width: 600px) {
    .lz-schedule-table td::before { font-size: 1rem; width: 95px; }
    .lz-schedule-table td:first-child { font-size: 1.25rem; }
  }
