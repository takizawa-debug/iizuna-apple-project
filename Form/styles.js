export const formStyles = `
  ...
  /* 🍎 カテゴリー選択：文字数に合わせる最適化 */
  .lz-choice-flex { display: flex; flex-wrap: wrap; gap: 1px; width: 100%; }
...
.lz-sub-choice-item {
  ...
  @media (max-width: 600px) {
    ...
    .lz-schedule-table td::before { content: attr(data-label); position: absolute; left: 10px; font-weight: 900; color: #5b3a1e; font-size: 0.85rem; width: 85px; }
