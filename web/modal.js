...
window.lzModal = (function() {
  ...
  var ICON = {
    ...
    tt:`<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M21 7.5a4.8 4.8 0 0 1-4.8-4.8c0-.2-.1-.3-.3-.3h-3.4c-.2 0-.3.1-.3.3v11.8a2.2 2.2 0 1 1-3.2-2c.1 0 .2-.1.2-.3V8.3c0-.2-.2-.4-.4-.4a6.7 6.7 0 1 0 6.7 6.6V10a9.2 9.2 0 0 0 4.9 1.4c.2 0 .3-.1.3-.3V7.8c0-.2-.1-.3-.3-.3z"/></svg>`
  };
