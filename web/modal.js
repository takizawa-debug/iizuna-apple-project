...
window.lzModal = (function() {
  ...
  var ICON = {
    ...
    line:`<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M23.1 10.5c0-4.6-4.9-8.4-11.1-8.4S.9 5.9.9 10.5c0 4.1 3.6 7.6 9.1 8.3.4.1.9.4 1 1l.4 2.1c.1.6.4.7.7.5.3-.3 1.6-2.1 2.2-2.9.2-.3.5-.5 1-.5 5.6-.3 7.8-3.7 7.8-8.5zM8.3 13.8H6.2c-.3 0-.5-.2-.5-.5V7.7c0-.3.2-.5.5-.5h.6c.3 0 .5.2.5.5v4.9h1c.3 0 .5.2.5.5v.6c0 .3-.2.5-.5.5zm3.1 0H11c-.3 0-.5-.2-.5-.5V7.7c0-.3.2-.5.5-.5h.6c.3 0 .5.2.5.5v5.6c0 .3-.2.5-.5.5zm4.6 0h-.6c-.2 0-.3-.1-.4-.2l-2.4-3.4v3c0 .3-.2.5-.5.5h-.6c-.3 0-.5-.2-.5-.5V7.7c0-.3.2-.5.5-.5h.6c.2 0 .3.1.4.2l2.4 3.4V7.7c0-.3.2-.5.5-.5h.6c.3 0 .5.2.5.5v5.6c0 .3-.2.5-.5.5zm4.5-3.1h-1.6v1.5h1.6c.3 0 .5.2.5.5v.6c0 .3-.2.5-.5.5h-2.2c-.3 0-.5-.2-.5-.5V7.7c0-.3.2-.5.5-.5h2.2c.3 0 .5.2.5.5v.6c0 .3-.2.5-.5.5h-1.6v1.5h1.6c.3 0 .5.2.5.5v.6c0 .3-.2.5-.5.5z"/></svg>`,
