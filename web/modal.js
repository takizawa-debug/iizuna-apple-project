...
window.lzModal = (function() {
  ...
  var ICON = {
    ...
    line:`<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M23 10.5C23 5.8 18.1 2 12 2S1 5.8 1 10.5c0 4.2 3.7 7.7 9.3 8.4.4.1.9.4 1 1l.4 2.3c.1.5.4.7.7.5.3-.3 1.6-2.1 2.2-3 .2-.3.5-.5 1-.5 5.7-.3 7.4-3.8 7.4-8.7zM8.5 14H6c-.3 0-.5-.2-.5-.5V7.5c0-.3.2-.5.5-.5h.7c.3 0 .5.2.5.5v5.3h1.3c.3 0 .5.2.5.5v.2c0 .3-.2.5-.5.5zm3.3 0h-.7c-.3 0-.5-.2-.5-.5V7.5c0-.3.2-.5.5-.5h.7c.3 0 .5.2.5.5v6c0 .3-.2.5-.5.5zm4.9 0h-.7c-.2 0-.3-.1-.4-.2l-2.5-3.6v3.1c0 .3-.2.5-.5.5h-.7c-.3 0-.5-.2-.5-.5V7.5c0-.3.2-.5.5-.5h.7c.2 0 .3.1.4.2l2.5 3.6V7.5c0-.3.2-.5.5-.5h.7c.3 0 .5.2.5.5v6c0 .3-.2.5-.5.5zm4.7-3.2h-1.7v1.6h1.7c.3 0 .5.2.5.5v.2c0 .3-.2.5-.5.5h-2.4c-.3 0-.5-.2-.5-.5V7.5c0-.3.2-.5.5-.5h2.4c.3 0 .5.2.5.5v.2c0 .3-.2.5-.5.5h-1.7v1.6h1.7c.3 0 .5.2.5.5v.2c0 .3-.2.5-.5.5z"/></svg>`,
    tt:`<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M15.5 2a4.5 4.5 0 0 0 .1 3.6 4.4 4.4 0 0 0 3.5 1.9v3A7.4 7.4 0 0 1 15.5 9V15.4a5.3 5.3 0 1 1-6.4-5.1V13a3.3 3.3 0 1 0 3.3 2.1V2z"/></svg>`
  };
