...
window.lzModal = (function() {
  ...
  var ICON = {
    ...
    line:`<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M22 10.4c0-4.1-4.5-7.4-10-7.4S2 6.3 2 10.4c0 3.7 3.5 6.7 8.4 7.3.3.1.8.4.9.9l.3 1.8c.1.5.3.6.6.4.3-.2 1.4-1.8 1.9-2.5.2-.2.4-.4.8-.4 5.1-.2 7.1-3.3 7.1-7.1zM8.3 13H6.7c-.2 0-.3-.1-.3-.3V8.3c0-.2.1-.3.3-.3h.4c.2 0 .3.1.3.3v3.7h1c.2 0 .3.1.3.3v.4c0 .2-.2.3-.4.3zm2.5 0h-.4c-.2 0-.3-.1-.3-.3V8.3c0-.2.1-.3.3-.3h.4c.2 0 .3.1.3.3v4.4c0 .2-.1.3-.3.3zm3.8 0h-.4c-.1 0-.2 0-.3-.1l-1.9-2.7v2.5c0 .2-.1.3-.3.3h-.4c-.2 0-.3-.1-.3-.3V8.3c0-.2.1-.3.3-.3h.4c.1 0 .2 0 .3.1l1.9 2.7V8.3c0-.2.1-.3.3-.3h.4c.2 0 .3.1.3.3v4.4c0 .2-.1.3-.3.3zm3.6-2.5h-1.1v1.2h1.1c.2 0 .3.1.3.3v.4c0 .2-.1.3-.3.3h-1.6c-.2 0-.3-.1-.3-.3V8.3c0-.2.1-.3.3-.3h1.6c.2 0 .3.1.3.3v.4c0 .2-.1.3-.3.3h-1.1v1.1h1.1c.2 0 .3.1.3.3v.4c0 .2-.1.3-.3.3z"/></svg>`,
    tt:`<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M16.4 2a4.4 4.4 0 0 0 .1 3.5 4.3 4.3 0 0 0 3.4 1.8v2.9a7.2 7.2 0 0 1-3.5-1.1V15a5 5 0 1 1-6.1-4.9V13a2.1 2.1 0 1 0 3.2 2V2z"/></svg>`
  };
