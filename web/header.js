(async function headerNavBoot(){
  ...
  const cssText = `
    ...
    /* --- プルダウンパネル（デザイナーズ・カスタム） --- */
    .lz-hnav__panel { 
      position: absolute !important; right: 0 !important; top: 100% !important; 
      background: #fff !important; color: #222 !important; 
      border-radius: 24px !important; /* もっと丸く可愛く */
      box-shadow: 0 20px 60px rgba(0,0,0,.15) !important; 
      padding: 12px !important; 
      display: none; 
      min-width: 260px !important; /* 少し広げてゆとりを */
      z-index: 10001 !important; 
      border: 1px solid rgba(0,0,0,0.04) !important;
      transform-origin: top center;
      animation: lz-slide-up 0.4s cubic-bezier(0.16, 1, 0.3, 1);
    }
    ...
    .lz-hnav__panel a { 
      ...
      border-radius: 16px !important; /* リンクも丸く */
      font-weight: 600 !important; 
      font-size: 1.35rem !important; /* フォントを大きく */
      border-bottom: none !important; /* 線は消してシンプルに */
      margin-bottom: 4px !important;
      transition: all 0.3s cubic-bezier(0.25, 0.46, 0.45, 0.94) !important;
      position: relative;
    }
    .lz-hnav__panel a:last-child { margin-bottom: 0 !important; }
    
    /* ホバー時の「押したくなる」演出 */
    .lz-hnav__panel a:hover { 
      background: var(--soft-red) !important; 
      color: var(--apple-red) !important; 
      padding-left: 26px !important; /* 少し右にずれる可愛さ */
    }
    .lz-hnav__panel a::before {
      content: ""; position: absolute; left: 8px; width: 4px; height: 0; 
      background: var(--apple-red); border-radius: 10px; transition: height 0.3s;
    }
    .lz-hnav__panel a:hover::before { height: 20px; }
    ...
    .lz-lang-pc__btn:hover { background: rgba(255,255,255,0.1); }
    ...
    .lz-lang-pc__menu { 
      position: absolute !important; right: 0 !important; top: 100% !important; margin-top: 8px !important; 
      background: #fff !important; border-radius: 20px !important; 
      box-shadow: 0 10px 30px rgba(0,0,0,.15) !important; padding: 10px !important; 
