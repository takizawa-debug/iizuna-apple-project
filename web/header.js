(async function headerNavBoot(){
  ...
  /* ==========================================
     1. CSSの注入 (デザイナーによるUIブラッシュアップ)
     ========================================== */
  const cssText = `
    :root { --content-max: 1100px; --hdr-h: 68px; --logo-size: 50px; --apple-red: #cf3a3a; --soft-red: #fff5f5; }
    ...
    .lz-t2 { font-weight: 800 !important; font-size: clamp(1.55rem, 2.7vw, 2.1rem) !important; letter-spacing: .02em !important; margin-top: 4px !important; }
    ...
    .lz-hnav__l1 { font-weight: 550 !important; font-size: clamp(1.22rem, 2.3vw, 1.58rem) !important; color: #fff !important; text-decoration: none !important; padding: 10px 14px !important; border-radius: 50px !important; transition: background .3s; }
    .lz-hnav__l1:hover { background: rgba(255, 255, 255, .15) !important; }
    
    /* PCプルダウン：可愛くてシンプルなデザイン */
    .lz-hnav__panel { 
      position: absolute !important; right: 0 !important; top: 100% !important; 
      background: #fff !important; color: #222 !important; border-radius: 16px !important; 
      box-shadow: 0 12px 40px rgba(0,0,0,.15) !important; padding: 12px !important; 
      display: none; min-width: 240px !important; z-index: 10001 !important; 
      border: 1px solid rgba(0,0,0,0.05);
    }
    .lz-hnav__panel.is-open { display: block !important; animation: lz-fade-up 0.3s ease-out; }
    @keyframes lz-fade-up { from { opacity: 0; transform: translateY(10px); } to { opacity: 1; transform: translateY(0); } }
    ...
    .lz-hnav__panel a { 
      ...
      font-weight: 600 !important; font-size: 1.35rem !important; transition: all .2s;
      position: relative; overflow: hidden;
      border-bottom: 1px solid #f8f8f8 !important;
    }
    .lz-hnav__panel a:last-child { border-bottom: none !important; }

    /* プルダウン項目のホバー演出：左に赤いライン */
    .lz-hnav__panel a::before {
      content: ""; position: absolute; left: 0; top: 0; bottom: 0; width: 4px;
      background: var(--apple-red); transform: translateX(-100%); transition: transform 0.2s;
    }
    .lz-hnav__panel a:hover { background: var(--soft-red) !important; color: var(--apple-red) !important; padding-left: 24px !important; }
    .lz-hnav__panel a:hover::before { transform: translateX(0); }

    /* 言語設定・PC（プルダウンも同様のデザインに） */
    ...
    .lz-lang-pc__btn { display: inline-flex !important; align-items: center !important; gap: 8px !important; height: 40px !important; padding: 0 16px !important; border: 1.5px solid rgba(255, 255, 255, .7) !important; background: transparent !important; color: #fff !important; border-radius: 50px !important; cursor: pointer !important; font-weight: 600; font-size: 1.1rem !important; }
    ...
    .lz-lang-pc__menu { position: absolute !important; right: 0 !important; top: 100% !important; margin-top: 8px !important; background: #fff !important; border-radius: 16px !important; box-shadow: 0 10px 30px rgba(0,0,0,.15) !important; padding: 8px !important; display: none; min-width: 180px !important; flex-direction: column !important; z-index: 10002; }
    .lz-lang-pc__menu.is-open { display: flex !important; animation: lz-fade-up 0.3s ease-out; }
    .lz-lang-pc__menu a { display: block !important; padding: 12px 16px !important; color: #444 !important; text-decoration: none !important; border-radius: 10px !important; font-weight: 600; font-size: 1.1rem; transition: all .2s; }
    .lz-lang-pc__menu a:hover:not(.is-disabled) { background: var(--soft-red); color: var(--apple-red); }
    .is-disabled { color: #bbb !important; cursor: not-allowed !important; opacity: 0.6; }

    /* スマホ・共通デザイン */
    .lz-lang-mob { position: relative !important; display: flex !important; }
    @media (min-width: 1024px) { .lz-lang-mob { display: none !important; } }
    .lz-lang-mob__btn { width: 42px !important; height: 42px !important; display: flex !important; align-items: center !important; justify-content: center !important; border: 1.5px solid rgba(255,255,255,0.7) !important; border-radius: 50% !important; color: #fff !important; font-size: 15px !important; font-weight: 700 !important; background: transparent !important; cursor: pointer; }
    .lz-lang-mob__menu { position: absolute !important; right: 0 !important; top: calc(100% + 12px) !important; background: #fff !important; border-radius: 16px !important; box-shadow: 0 8px 25px rgba(0,0,0,0.2) !important; padding: 8px !important; display: none; min-width: 160px !important; flex-direction: column !important; z-index: 10003; }
    .lz-lang-mob__menu.is-open { display: flex !important; }
    .lz-lang-mob__menu a { display: block !important; padding: 14px 16px !important; color: #333 !important; text-decoration: none !important; font-size: 1.15rem !important; font-weight: 600 !important; border-radius: 10px !important; }

    /* スマホドロワー（L2フォント拡大） */
    .lz-hamb { display: flex !important; width: 44px !important; height: 44px !important; border: 1.5px solid rgba(255,255,255,0.7) !important; background: transparent !important; border-radius: 10px !important; color: #fff !important; flex-direction: column !important; justify-content: center !important; align-items: center !important; gap: 6px !important; cursor: pointer; }
    ...
    .lz-drawer { position: fixed !important; right: 0 !important; top: 0 !important; bottom: 0 !important; width: 85vw !important; max-width: 340px !important; background: #fff !important; z-index: 20001 !important; transform: translateX(100%) !important; transition: transform .4s cubic-bezier(0.16, 1, 0.3, 1) !important; overflow-y: auto !important; }
    .lz-drawer.is-open { transform: translateX(0) !important; }
    .lz-dw-group { border-bottom: 1px solid #f0f0f0; }
    .lz-dw-l1a { flex: 1; display: block; padding: 20px !important; font-weight: 700 !important; font-size: 1.25rem !important; color: #333 !important; text-decoration: none !important; }
    .lz-dw-arrow { padding: 20px !important; color: var(--apple-red); cursor: pointer; transition: transform .3s; font-size: 1.4rem; }
    .lz-dw-l2-area { background: #fafafa !important; display: none; padding: 5px 0 15px 35px !important; }
    .lz-dw-group.is-active .lz-dw-l2-area { display: block !important; }
    .lz-dw-l2-area a { display: block !important; padding: 14px 0 !important; color: #555 !important; text-decoration: none !important; font-size: 1.15rem !important; font-weight: 600 !important; }
  ...
  <aside class="lz-drawer" id="lzDrawer">
    <div class="lz-dw-head" style="padding:18px 20px; border-bottom:1px solid #eee; display:flex; justify-content:space-between; align-items:center;">
      <div style="font-weight:bold; font-size:1.3rem; color:#333;">メニュー</div>
  ...
  function renderSkeleton(){
    ...
    const onScroll = () => { if (window.scrollY > 20) { hdr.classList.add('is-visible'); window.removeEventListener('scroll', onScroll); } };
    ...
    if(json.ok) {
      ...
      MENU_ORDER.forEach((l1, i) => {
        ...
        if(dwGroups[i]) {
          ...
          } else { area.innerHTML = ''; area.style.padding = '0'; arrow.style.display='none'; link.onclick=closeDrawer; }
        }
      });
    }
