...
(async function headerNavBoot(){
  ...
  const cssText = `
    ...
    .lz-h-t1 { font-weight: 400 !important; font-size: clamp(1.05rem, 2vw, 1.35rem) !important; opacity: .9 !important; }
    .lz-h-t2 { font-weight: 800 !important; font-size: clamp(1.65rem, 3vw, 2.2rem) !important; letter-spacing: .01em !important; }
