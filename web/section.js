/**
 * section.js - 記事一覧コンポーネント (位置調整・アニメーション完結版)
 * 役割: 記事カード生成、中央揃えロードアニメ、プレースホルダー、自動再生
 */
(function() {
  "use strict";
  ...
  var injectStyles = function() {
    ...
    style.textContent = [
      ...
      '.lz-section { margin: 48px 0; position: relative; min-height: 460px; }', 
      ...
      /* ロード画面のレイアウト修正 */
      '.lz-loading { display: flex; align-items: center; justify-content: center; height: 360px; border: 1px dashed var(--border); border-radius: 12px; background: #fffaf8; }',
      '.lz-loading-inner { display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 8px; color: #a94a4a; }',
      
      /* ★SVGの位置調整：-70pxの左マージンで文字との中心を合わせる */
      ...
      '.lz-loading-label { font-weight: 600; font-size: 1.4rem; letter-spacing: .05em; text-indent: 10px; }', /* 文字も微調整 */
  ...
  window.renderSection = async function(root) {
    ...
    root.innerHTML = [
      ...
      '        <svg class="lz-logo" viewBox="-60 -60 720 720" preserveAspectRatio="xMidYMid meet" style="overflow:visible">',
