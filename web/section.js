/**
 * section.js - 記事一覧コンポーネント (完全再現版)
 * 役割: 記事カード生成、中央揃えロードアニメ、画像なし対応、自動再生
 */
(function() {
  "use strict";
  ...
  var injectStyles = function() {
    ...
    style.textContent = [
      /* 記事読み込み前の枠を確保 */
      '.lz-section { visibility: hidden; margin: 48px 0; contain: content; position: relative; min-height: 500px; }',
  ...
  window.renderSection = async function(root) {
    ...
    root.innerHTML = [
      ...
      '        <svg class="lz-logo" viewBox="-60 -60 720 720" preserveAspectRatio="xMidYMid meet">',
