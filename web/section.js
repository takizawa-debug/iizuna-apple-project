/**
 * section.js - 記事一覧コンポーネント (Double-Sided Infinity Edition)
 * 役割: 左右双方向ループ、全デバイス自動コンベア、黄金比ロードアニメ復元
 */
(function() {
  "use strict";
  ...
  function setupInfinityTrack(track) {
    ...
    track.innerHTML = originalContent + originalContent + originalContent; // 3重にして中央から開始
