/**
 * section.js - 記事一覧コンポーネント (高機能復元版)
 * 役割: 記事カード生成、読み込みアニメーション、プレースホルダー、自動再生
 */
(function() {
  "use strict";
  ...
  var injectStyles = function() {
    ...
    style.textContent = [
      '.lz-section { margin: 48px 0; position: relative; min-height: 400px; }', /* 枠の確保 */
      ...
      /* ローディングアニメーション */
      '.lz-loading { display: flex; align-items: center; justify-content: center; height: var(--loading-h, 300px); border: 1px dashed var(--border); border-radius: 12px; background: #fffaf8; }',
      ...
      '.lz-loading-label { font-weight: 600; letter-spacing: .02em; }'
    ].join('\n');
