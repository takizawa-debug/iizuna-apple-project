/**
 * section.js - 記事一覧コンポーネント (Manual Infinity Edition)
 * 役割: 左右双方向ループ(手動専用)、中項目書式復元、黄金比ロードアニメ
 */
(function() {
  "use strict";
